...
next=0;
 ...
 while logical
     ...
     for roij=1:size(roifile,2)
       ...
       [output,epsilon] =selectclusters(labeledall,handles.datax ,handles.datay,handles.fr,handles.alpha,limitdens,minnrodetect,mindiamcluster,maxdiamcluster,minpointsnano,epsilon);
       ...
       if isempty(rendxmask)==0
           ...
           save([namefile,'-roidata_',num2str(roij),'.mat'],'auxoutx','auxouty','imagemask','limitdens','xdimmask', 'ydimmask',...
